...
@Component({
  ...
  styleUrls: ['./world-stories.component.css']
})
export class WorldStoriesComponent {
  ...
  ngOnInit(): void {
   this.newsApi.topWorldHeadlines().subscribe(response=>{
      console.log("Data received from World Stories",response);
